...
export default function Achievement() {
  return (
    <SimpleLayout
      ...
      intro="I regularly participate in competitions and hackathons since high school to develop essential skills. These are the achievements from the past few years I am most proud of"
    >
      <div className="space-y-20">
        ...
        <AchievementSection title="Scholarships">
          {scholarships.map((achievement) => (
            <Appearance
              key={achievement.title}
              href={achievement.href}
              title={achievement.title}
